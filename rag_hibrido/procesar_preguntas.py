...
from buscar_contexto import recuperar_contexto, cargar_recursos
...
def procesar_pregunta(fila: dict, modelo_embeddings, coleccion, chunks_por_id, bm25, ids_bm25, cliente) -> None:
    """Recupera contexto, genera la respuesta y la guarda."""
    id_pregunta = fila["id"]
    pregunta = fila["pregunta"]

    # ✅ Pasar todos los argumentos necesarios
    ...
    respuesta, contexto = generar_con_reintentos(pregunta, resultados, cliente)
...
def main() -> int:
    ...
    try:
        ...
        # ✅ Ahora recibimos todos los argumentos
        modelo_embeddings, coleccion, chunks_por_id, bm25, ids_bm25 = cargar_recursos()
