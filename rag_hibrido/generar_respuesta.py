...
def main() -> int:
    ...
    print("=" * 70)
    print("ETAPA D - RAG HÍBRIDO CON GENERACIÓN DE RESPUESTAS")
    print("=" * 70)

    try:
        print("Cargando modelo, ChromaDB e índice BM25...")

        modelo_embeddings, coleccion, chunks_por_id, bm25, ids_bm25 = (
            cargar_recursos()
        )
    ...
    while True:
        ...
        try:
            resultados = recuperar_contexto(pregunta,modelo_embeddings,coleccion,chunks_por_id,bm25,ids_bm25,)
